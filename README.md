...
| Name | Role | Phase |
|---|---|---|
| Harith | Data Engineer | Part 1 — Data Preparation |
| Fahmie | Data Scientist | Part 2 — Data Modelling |
| Hakiem | Data Analyst | Part 3 — Data Visualisation & Evaluation |
...
> **Note:** The trained model files and the image dataset are too large to store
> directly in this repository. They are attached to the
> [latest Release](../../releases) of this repo:
>
> - `ResNet50.keras` — ResNet50 trained model
> - `DenseNet121.keras` — DenseNet121 trained model
> - `MobileNetV3.keras` — MobileNetV3 trained model
> - `dataset.zip` — Full cleaned dataset (train / val / test, 5 breeds, 5,000 images)
>
> Download them from the Release page and place them in the same folder as the
